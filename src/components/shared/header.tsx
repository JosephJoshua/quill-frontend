          ...
          <nav className="flex items-center space-x-6 text-sm font-medium">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="px-0 text-sm font-medium transition-colors hover:text-foreground/80 text-foreground/60 focus-visible:ring-0 focus-visible:ring-offset-0 data-[state=open]:text-foreground/80">
                  {t('nav.srs')}
