...
export default function LibraryPage() {
  ...
  const queryParams = { q: debouncedSearchTerm, language, difficultyLevel: difficulty, page: currentPage, limit: PAGE_LIMIT };
    ...
    <div className="container p-4 sm:p-8">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        ...
        <div className="flex flex-col sm:flex-row w-full sm:w-auto gap-2">
          ...
          <Select value={language} onValueChange={(v) => { setLanguage(v as Language | ""); setCurrentPage(1); }}>
          ...
          <Select value={difficulty} onValueChange={(v) => { setDifficulty(v as CefrLevel | ""); setCurrentPage(1); }}>
