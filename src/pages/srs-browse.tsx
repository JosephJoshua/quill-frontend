...
const EditCardDialog = ({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>{t("srs.browse.edit")}</DialogTitle>
        </DialogHeader>
        <Form {...form}>
  ...
  return (
    <div className="container p-4 sm:p-8">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        ...
        <Input
          placeholder={t("srs.browse.searchPlaceholder")}
          value={searchTerm}
      ...
      <div className="rounded-md border">
        <Table>
          <TableHeader>
            <TableRow>
              <TableHead>{t("srs.browse.table.front")}</TableHead>
              <TableHead>{t("srs.browse.table.back")}</TableHead>
              <TableHead className="hidden md:table-cell">
                {t("srs.browse.table.dueDate")}
              </TableHead>
              <TableHead>
                <span className="sr-only">{t("srs.browse.table.actions")}</span>
              </TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
                  ...
                  <TableCell className="text-right">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        <DropdownMenuItem onClick={() => setCardToEdit(card)}>
                          {t("srs.browse.edit")}
                        </DropdownMenuItem>
                        <DropdownMenuItem
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>
              {t("srs.browse.deleteConfirmTitle")}
            </AlertDialogTitle>
            <AlertDialogDescription>
              {t("srs.browse.deleteConfirmDescription")}
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
